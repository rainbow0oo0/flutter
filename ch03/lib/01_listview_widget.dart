...
class ListViewTest3 extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    List<User> userList = [
      User('a101', '김유신', '1990-09-01', 23, 'https://picsum.photos/seed/picsum/200/300'),
      User('a102', '김춘추', '1990-09-01', 21, 'https://picsum.photos/200/300/?blur'),
      User('a103', '장보고', '1990-09-01', 33, 'https://picsum.photos/id/870/200/300?grayscale&blur=2'),
      User('a104', '강감찬', '1990-09-01', 43, 'https://picsum.photos/id/237/200/300'),
      User('a105', '이순신', '1990-09-01', 53, 'https://picsum.photos/200')
    ];

    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text('03.ListView seperated 실습'),),
        body: ListView.separated(          // ListView.separted는 ListView.builder에서 목록 구분선을 커스텀 할 수 있는 위젯
