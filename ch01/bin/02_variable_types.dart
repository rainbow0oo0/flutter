...
// 변수와 기본 타입
  ...
  int age = 23;
  double height = 177.2;
  bool isStudent = true; // Java Boolean 참 거짓
  num score = 100; // 숫자형(int, double 포함하는 상위 타입)
  var address = '부산시'; // 자동 추본 타입(컴파일 시점, 최초 한번 타입이 정해지면 변경 불가)
  dynamic etc = '기타'; // 자동 타입 결정(런타임 시점, 최초 한번 타입이 정해져도 변경 가능)
  ...
  const num2 = 200; // 컴파일 타임 상수, 클래스 맴버로 사용
